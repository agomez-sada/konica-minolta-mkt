view: events_intraday_20221005 {
  sql_table_name: `analytics_271637361.events_intraday_20221005`
    ;;
...
view: events_intraday_20221005__items {
  ...
  dimension: events_intraday_20221005__items {
    type: string
    hidden: yes
    sql: events_intraday_20221005__items ;;
  }
...
view: events_intraday_20221005__event_params {
  dimension: events_intraday_20221005__event_params {
    type: string
    hidden: yes
    sql: events_intraday_20221005__event_params ;;
  }
...
view: events_intraday_20221005__user_properties {
  dimension: events_intraday_20221005__user_properties {
    type: string
    hidden: yes
    sql: events_intraday_20221005__user_properties ;;
  }
