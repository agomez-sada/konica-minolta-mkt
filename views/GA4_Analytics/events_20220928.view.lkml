view: events_20220928 {
  sql_table_name: `analytics_271637361.events_20220928`
    ;;
...
view: events_20220928__items {
  ...
  dimension: events_20220928__items {
    type: string
    hidden: yes
    sql: events_20220928__items ;;
  }
...
view: events_20220928__event_params {
  dimension: events_20220928__event_params {
    type: string
    hidden: yes
    sql: events_20220928__event_params ;;
  }
...
view: events_20220928__user_properties {
  dimension: events_20220928__user_properties {
    type: string
    hidden: yes
    sql: events_20220928__user_properties ;;
  }
