view: events_20221001 {
  sql_table_name: `analytics_271637361.events_20221001`
    ;;
...
view: events_20221001__items {
  ...
  dimension: events_20221001__items {
    type: string
    hidden: yes
    sql: events_20221001__items ;;
  }
...
view: events_20221001__event_params {
  dimension: events_20221001__event_params {
    type: string
    hidden: yes
    sql: events_20221001__event_params ;;
  }
...
view: events_20221001__user_properties {
  dimension: events_20221001__user_properties {
    type: string
    hidden: yes
    sql: events_20221001__user_properties ;;
  }
