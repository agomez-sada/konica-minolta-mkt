view: events_20221002 {
  sql_table_name: `analytics_271637361.events_20221002`
    ;;
...
view: events_20221002__items {
  ...
  dimension: events_20221002__items {
    type: string
    hidden: yes
    sql: events_20221002__items ;;
  }
...
view: events_20221002__event_params {
  dimension: events_20221002__event_params {
    type: string
    hidden: yes
    sql: events_20221002__event_params ;;
  }
...
view: events_20221002__user_properties {
  dimension: events_20221002__user_properties {
    type: string
    hidden: yes
    sql: events_20221002__user_properties ;;
  }
