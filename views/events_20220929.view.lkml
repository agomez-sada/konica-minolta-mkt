view: events_20220929 {
  sql_table_name: `analytics_271637361.events_20220929`
    ;;
...
view: events_20220929__items {
  ...
  dimension: events_20220929__items {
    type: string
    hidden: yes
    sql: events_20220929__items ;;
  }
...
view: events_20220929__event_params {
  dimension: events_20220929__event_params {
    type: string
    hidden: yes
    sql: events_20220929__event_params ;;
  }
...
view: events_20220929__user_properties {
  dimension: events_20220929__user_properties {
    type: string
    hidden: yes
    sql: events_20220929__user_properties ;;
  }
